...
<html lang="es">
    ...
    <body>
        ...
        <div class="all">
            <div class="main">
                <form method="POST" action="../funcionalidad/alta_proveedores.php">
                    <h1>Alta de provedor</h1>
                    <p>Ingrese los datos del proveedor a dar de alta</p>
